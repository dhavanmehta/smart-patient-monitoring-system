	...
	<a href = "logout.php">		<button id="showLeftPush" class="active"><i class="fa fa-sign-out"></i></button></a>
		...
		<div id="page-wrapper">
			...
			<div class="row" style="padding-bottom: 50px">
				<div class="com-md-5 col-md-offset-5"><h1>Welcome Admin</h1></div>
			</div>

				<!-- four-grids -->
				<div class="row four-grids">
					<a href="add_patient.php">
					<div class="col-md-3 ticket-grid col-md-offset-1">
						<div class="tickets">
							<div class="grid-left">
								<div class="book-icon">
					...
					<a href="patient.php">
					<div class="col-md-3 ticket-grid" data-toggle="modal" data-target="#myModal">
						<div class="tickets">
							<div class="grid-left">
								<div class="book-icon">
									<i class="fa fa-user"></i>
